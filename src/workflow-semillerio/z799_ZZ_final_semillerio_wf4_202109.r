...
PARAM  <- list()
PARAM$experimento  <- "ZZ7990_wf4_202109"
PARAM$exp_input  <- "HT7510_wf4_202109"
...
PARAM$semilla_primos  <- 874793  # se utiliza para generar el vector de  PARAM$semillerio  semillas
...
arch_log  <- paste0( PARAM$home, "exp/", PARAM$exp_input, "/BOedit_log.txt" )
