...
PARAM  <- list()
PARAM$experimento  <- "HT7510_wf4_202109"

PARAM$exp_input  <- "TS7410_wf4_202109"

PARAM$lgb_crossvalidation_folds  <- 5  #En caso que se haga cross validation, se usa esta cantidad de folds

PARAM$lgb_semilla  <- 874793   #cambiar por su propia semilla
...
PARAM$bo_iteraciones  <- 12  #iteraciones de la Optimizacion Bayesiana
