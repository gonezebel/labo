...
PARAM  <- list()
PARAM$experimento <- "TS7410_wf3"

PARAM$exp_input  <- "FE7310_wf3"

# me salteo los meses duros de pandemia, pero llego hasta 201907 en training
# entreno en 18 meses

PARAM$future       <- c( 202107 )
PARAM$final_train  <- c( 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 202004, 202003, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905,201904)

PARAM$train$training     <- c(202104, 202103, 202102, 202101, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 202004, 202003, 202002, 202001, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902, 201901)
PARAM$train$validation   <- c( 202105 )
PARAM$train$testing      <- c( 202012, 201912 )
...
PARAM$train$semilla  <- 874793  # cambiar por su propia semilla  !!!
