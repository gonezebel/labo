...
PARAM  <- list()
PARAM$experimento  <- "DR6210_rank_simple_2var_nuevas"
...
AgregarVariables_IntraMes  <- function( dataset )
{
  ...
  dataset[  , meses_promedio_pago_prestamos  := ((mprestamos_personales+mprestamos_prendarios+mprestamos_hipotecarios)/(mpayroll+mpayroll2)) ]
