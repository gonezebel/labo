...
PARAM  <- list()
PARAM$experimento <- "HT6510_deflacion_mas_cero_fijo_f202106"

PARAM$exp_input  <- "TS6410_deflacion_mas_cero_fijo_f202106"

PARAM$lgb_crossvalidation_folds  <- 5  #En caso que se haga cross validation, se usa esta cantidad de folds

PARAM$lgb_semilla  <- 241507   #cambiar por su propia semilla
