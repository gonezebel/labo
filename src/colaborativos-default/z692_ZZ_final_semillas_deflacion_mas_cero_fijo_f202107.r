...
PARAM  <- list()
PARAM$experimento  <- "ZZ6920_deflacion_mas_cero_fijo_f202107"
PARAM$exp_input  <- "HT6510_deflacion_mas_cero_fijo_f202107"
...
PARAM$semillas  <- c( 241507,383939,622049,700343,874793 ) #reemplazar por las propias semillas
