...
PARAM  <- list()
PARAM$experimento <- "TS6410_deflacion_mas_cero_fijo_f202106"

PARAM$exp_input  <- "FE6310_deflacion_mas_cero_fijo"
...
PARAM$train$semilla  <- 241507  # cambiar por su propia semilla  !!! 
