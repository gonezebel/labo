...
PARAM  <- list()
PARAM$experimento  <- "ZZ6910_cero_fijo_622049"
PARAM$exp_input  <- "HT6510_cero_fijo_241507"

PARAM$modelos  <- 2       #aumentar si se quieren mas modelos
PARAM$semilla  <- 622049  # siempre se debera probar con 5 semillas, en 5 experimentos distintos, y presentar la media y/o los graficos detallados de las cinco curvas si corresponde
