...
PARAM  <- list()
PARAM$experimento <- "TS6410_rank_simple_2var_nuevas_383939"

PARAM$exp_input  <- "FE6310_rank_simple_2var_nuevas"
...
PARAM$train$semilla  <- 383939  # cambiar por su propia semilla  !!! 
